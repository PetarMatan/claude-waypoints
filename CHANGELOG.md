...
### Added
- **Release automation script** - `scripts/release.sh` automates the release process (version updates, tagging, GitHub release creation, reverting to main)

### Fixed
- **Installer version pinning** - `install.sh` now installs from tagged release version instead of always pulling from main branch
